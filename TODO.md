#### MVP TODO
- [x] Generic car modeling over C ABI [DONE]
...
- [x] Fix so that the model parameter loader can read in "infinity" from yaml file [DONE]
- [x] Add simulation run speed and dt parameters in Simulation Control tab [DONE]
- [x] Add car sprite marker [DONE]
...
- [x] GUI configuration cache file [DONE]
